    ...
    */
    ...
    #include <linux/radio_ctrl/mdm6610_ctrl.h>
    ...
    static const char *mdmctrl = "mdm6610_ctrl";
    ...
    static struct platform_driver mdm6610_ctrl_driver = {
    ...
    static int __init mdm6610_ctrl_init(void)
    {
            printk(KERN_DEBUG "mdm6610_ctrl_init\n");
            return platform_driver_register(&mdm6610_ctrl_driver);
    }

    static void __exit mdm6610_ctrl_exit(void)
    {
            printk(KERN_DEBUG "mdm6610_ctrl_exit\n");
            platform_driver_unregister(&mdm6610_ctrl_driver);
    }

    module_init(mdm6610_ctrl_init);
    module_exit(mdm6610_ctrl_exit);

    MODULE_AUTHOR("Ramon Rebersak <fergy@idroidproject.org>");
    MODULE_DESCRIPTION("MDM6610 Control Driver");
    MODULE_VERSION("1.0");
    MODULE_LICENSE("GPL");
