/*
 * Battery charger driver for Apple iPhone 3G/GS
 *
 * Copyright © 2013  Ramon Rebersak <fergy@idroidproject.org>
...
static int __init ltc4088_charger_probe(struct platform_device *pdev)
{
	int rc;
	struct ltc4088_chg_chip *chip;
...
static int __exit ltc4088_charger_remove(struct platform_device *pdev)
{
